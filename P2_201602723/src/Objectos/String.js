...
class String {
    constructor() { }
    static GuardarCadena(cadena) {
        const resultado = new nodoCodigo_1.nodoCodigo();
        let tem = resultado.Crear_Temporal();
        resultado.EstablecerCabeza(tem, auxExpresion_1.auxExpresion.COMBINACION_TIPOS.STRING);
    ...
    static GuardarLetra(letra) {
        const resultado = new nodoCodigo_1.nodoCodigo();
        let cabeza = resultado.Crear_Temporal();
        resultado.EstablecerCabeza(cabeza, auxExpresion_1.auxExpresion.COMBINACION_TIPOS.STRING);
    ...
    static CompararCadenas(cad1, cad2) {
        ...
        resultado.EstablecerCabeza(cabeza, auxExpresion_1.auxExpresion.COMBINACION_TIPOS.BOOL);
        const etq1 = resultado.Crear_Etiqueta();
        const etq2 = resultado.Crear_Etiqueta();
        const etq3 = resultado.Crear_Etiqueta();
        const etq4 = resultado.Crear_Etiqueta();
    ...
    static CompararCadenas2(cad1, cad2) {
        let resultado = new nodoCodigo_1.nodoCodigo();
        let cabeza = resultado.Crear_Temporal();
        let tem1 = resultado.Crear_Temporal();
        let tem2 = resultado.Crear_Temporal();
