...
export class Sentencia_While extends nodoAst {
    ...
    Ejecutar(e: Entorno): nodoCodigo {
        ...
        if(condicion.tipo != auxExpresion.COMBINACION_TIPOS.BOOL){
            Informacion.ErrSemantico("Se necesita un valor Booleano en la condicion del While", 
        ...
        let nuevoEntorno = new Entorno("while",e,e.contador);
